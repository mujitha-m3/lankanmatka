...
<head>
    ...
    <title>Exercise 1: Getting Started with </title>
...
of three students in the course. To display this information, create an HTML table within 
your PHP code. The table should be structured with columns for Serial Number (S.n.), Name, 
and Grade, and it should look like this:</h3>
...
<table>
    <tr><td>S.n.</td><td>Name</td><td>Grade</td></tr>
...
<h3>3.4. Take a screenshot that confirms your development environment 
    setup and include it as an image in the "ex1.php" file.</h3>
