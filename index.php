...
<section id="home">
    ...
    <div class="popup" id="popup-1">
        ...
        <div class="content">
            ...
            <h1>Kandy</h1>
            <img src="assets/images/trip-plans-card-img/sri-dalada-maligawa.jpg" alt="sri-dalada-maligawa">
            <img src="assets/images/kandy/lake-mob.jpg" alt="lake-mob">
            <img src="assets/images/kandy/Peridenya-Gardens-kandy-sri-lanka1.jpg" alt="Peridenya-Gardens-kandy-sri-lanka1">
            <img src="assets/images/kandy/istockphoto-169941463-612x612.jpg" alt="istockphoto-169941463-612x612">
            <h3>Things to do & Package Description</h3>
            <ul>
                <li>Arrival at Colombo Sri Lanka (Bandaranaike International airport).</li>
                <li>Enjoy a warm welcome by our Lankan Matka officer and driver at
                    the airport.</li>
                <li>Proceed to the ancient city of Kandy.</li>
                <li>Check-in at the antique-style hotel and relax.</li>
                <li>Visit to Kandy Temple of tooth.</li>
                <li>Visit to Peradeniya Botanical Garden.</li>
            </ul>
